...
export const ModernBento: React.FC<{ slots: Record<string, React.ReactNode> }> = ({ slots }) => (
  <div className="grid grid-cols-1 md:grid-cols-12 gap-6 p-6 min-h-screen">
    ...
    <div className="md:col-span-4 space-y-6">
      <div className="h-64 border text-black bg-gray-50">{slots["s1"]}</div>
      <div className="h-64 border text-black bg-gray-50">{slots["s2"]}</div>
    </div>
